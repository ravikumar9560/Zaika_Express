...
export const ResMenu = () => {
  ...
  const fetchData = async (resId) => {
    try {
      const response = await fetch(
        `https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=28.615962&lng=77.060464&restaurantId=${resId}&catalog_qa=undefined&submitAction=ENTER`
      );
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-white shadow-lg rounded-lg">
      ...
      <h2 className="text-2xl font-sans text-center text-gray-600 mt-2">
        {costForTwoMessage}
      </h2>
